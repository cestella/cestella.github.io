...
Thinking beyond this analysis, I plan to go on and look at some of the other graph theoretic invariants that we can track over time:
...
* Applying the same analysis to other blockchains, like Bitcoin.
